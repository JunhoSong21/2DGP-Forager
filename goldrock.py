...
class GoldRock:
    ...
    def __init__(self):
        ...
        if GoldRock.destroy == None:
            GoldRock.destroy = pico2d.load_wav('Sounds/RockDestroy.wav')
            GoldRock.destroy.set_volume(60)
