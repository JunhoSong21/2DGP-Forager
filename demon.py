...
class Demon:
    ...
    def __init__(self):
        ...
        if Demon.image == None:
            Demon.image = pico2d.load_image('Sprites/DemonIdle.png')

        self.imageCursor = pico2d.load_image('Sprites/ObjectCursor.png')
        self.hp = 7
        self.font = pico2d.load_font('Sprites/DungGeunMo.ttf', 24)

        self.bgm1 = pico2d.load_wav('Sounds/HitDemon.wav')
        self.bgm2 = pico2d.load_wav('Sounds/HitDemon.wav')
    ...
    def draw(self):
        ...
        frameX = int(self.frame) * 21
        self.image.clip_draw(frameX, 0, 21, 16, self.x, self.y, 42, 32)
